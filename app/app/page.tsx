      ...
      <header className={`border-b border-[#d9ded8] bg-[#f9f8f4]/95 px-4 backdrop-blur md:px-6 ${presentationMode ? 'py-2' : 'py-3'}`}>
        <div className="mx-auto flex max-w-[1800px] items-center justify-between gap-4">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0"><p className="truncate text-sm font-semibold">Realtime Architecture Sync</p><p className="text-xs text-[#596763]">Zoom / Microsoft Teams · 共有ディスカッションworkspace</p></div>
          </div>
